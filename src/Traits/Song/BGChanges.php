...
trait BGChanges
{
     ...
     * @return string
     */
    public function getBgChanges() {
        return $this->bgChanges;
    }

    /**
     * @param string $bgChanges
     *
     * @return $this
     * @throws SMException
     */
    public function setBgChanges($bgChanges) {
        if (!is_string($bgChanges)) {
            throw new SMException("BgChanges must be a string");
        }
